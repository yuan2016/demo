<template>
  <div class="dailyRepaymentUnitData" v-loading.body="loading" element-loading-text="拼命加载中" :style="{ height: dHeight + 'px' }">
    <banner></banner>
    ...
    <el-table :data="fundData" highlight-current-row border stripe style="width: 100%;overflow: auto" :height="height" class="dailyRepaymentUnitData-table" @sort-change="sort">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      getData () {
        return this.axios.post('/api/dailyRepaymentUnitData', {
          limit: this.limit,
          offset: this.offset,
      ...
      getCount () {
        return this.axios.post('/api/dailyRepaymentUnitData/count', {
          startTime: this.startTime,
          endTime: this.endTime
        })
      },
      ...
      refreshData () {
        ...
        this.axios.post('/api/dailyRepaymentUnitData/refresh').then((response) => {
