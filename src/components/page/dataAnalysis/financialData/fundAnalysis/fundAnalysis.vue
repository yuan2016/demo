<template>
  <div class="fundAnalysis" v-loading.body="loading" element-loading-text="拼命加载中" :style="{ height: dHeight + 'px' }">
    <banner></banner>
  ...
  export default {
    ...
    methods: {
      ...
      refreshData () {
        ...
        this.axios.post('/api/fundAnalysis/refresh').then((response) => {
