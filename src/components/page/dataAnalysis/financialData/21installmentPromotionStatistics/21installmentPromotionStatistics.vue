<template>
  <div class="installmentPromotionStatistics" v-loading.body="loading" element-loading-text="拼命加载中" :style="{ height: dHeight + 'px' }">
    <banner></banner>
...
<style lang="stylus" rel="stylesheet/stylus">
  .installmentPromotionStatistics
    height: 100%
    .installmentPromotionStatistics-table
      border-radius :10px
    .date-filter
